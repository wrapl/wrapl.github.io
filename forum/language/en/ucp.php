...
$lang = array_merge($lang, array(
	...
	'UCP_ADMIN_ACTIVATE'		=> 'In order to activate your account, please send an email to the %sBoard Administrator%s from the email address you enter below.',
	'UCP_AIM'					=> 'AOL Instant Messenger',
	'UCP_ATTACHMENTS'			=> 'Attachments',
	'UCP_COPPA_BEFORE'			=> 'Before %s',
	'UCP_COPPA_ON_AFTER'		=> 'On or after %s',
	'UCP_EMAIL_ACTIVATE'		=> 'In order to activate your account, please send an email to the %sBoard Administrator%s from the email address you enter below.',
	'UCP_ICQ'					=> 'ICQ number',
